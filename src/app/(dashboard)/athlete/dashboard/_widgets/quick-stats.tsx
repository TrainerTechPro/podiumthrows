...
export function QuickStatsWidget({ data }: { data: QuickStatsData }) {
  return (
    <div className="grid grid-cols-3 gap-3">
      <div className="card px-4 py-3.5 text-center shadow-sm md:hover:shadow-md md:transition-shadow">
        ...
        <p className="text-micro text-muted mt-0.5">This Week</p>
      </div>
      ...
      <div className="card px-4 py-3.5 text-center shadow-sm md:hover:shadow-md md:transition-shadow">
        ...
        <p className="text-micro text-muted mt-0.5">Day Streak</p>
      </div>
      ...
      <div className="card px-4 py-3.5 text-center shadow-sm md:hover:shadow-md md:transition-shadow">
        ...
        <p className="text-micro text-muted mt-0.5">Total Sessions</p>
      </div>
    </div>
  );
}
