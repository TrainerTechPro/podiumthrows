...
export default function AthleteThrowsPage() {
 ...
 <Link href="/athlete/throws/readiness" className="action-chip animate-chip-in">
 ...
 <Link href="/athlete/throws/trends" className="action-chip animate-chip-in animate-delay-150">
