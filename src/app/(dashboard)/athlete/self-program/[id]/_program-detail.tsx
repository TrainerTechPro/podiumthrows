          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {allSessions.every((s) => s.status === "COMPLETED" || s.status === "SKIPPED") ? (
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-info-50 dark:bg-info-500/10 text-info-700 dark:text-info-300 border border-info-200 dark:border-info-500/30">
                  Complete
                </span>
              ) : (
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-success-50 dark:bg-success-500/10 text-success-700 dark:text-success-300 border border-success-200 dark:border-success-500/30">
                  Active
                </span>
              )}
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-primary-50 dark:bg-primary-500/10 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-500/30">
                Self-Generated
              </span>
            </div>
          </div>
