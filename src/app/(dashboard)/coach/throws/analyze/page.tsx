  ...
  return (
    <div className="animate-spring-up space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/coach/throws/analyze/history" className="btn-secondary text-sm">
          View History
        </Link>
      </div>
      ...
      <div className="flex items-center gap-2">
        {[1, 2, 3].map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 3 && (
              <div
                className={`w-12 h-0.5 ${step > s ? "bg-primary-500" : "bg-[var(--muted-bg)]"}`}
              />
            )}
          </div>
        ))}
      ...
      {step === 1 && (
        <div className="card space-y-6 stagger-spring">
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Step 1: Calibration</h2>
      ...
      {step === 2 && (
        <div className="card space-y-6">
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Step 2: Upload Video</h2>
          ...
          <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-4">
            ...
            <ul className="text-sm text-primary-700 dark:text-primary-300 space-y-1">
              <li>
                - Film from the{" "}
                {CAMERA_OPTIONS.find((c) => c.value === cameraAngle)?.label.toLowerCase()} for this
                analysis
              </li>
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-colors ${
              videoFile
                ...
                : "border-[var(--color-border-strong)] hover:border-primary-400 dark:hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/10"
            }`}
          >
            <input
              ref={fileInputRef}
            ...
            {videoFile ? (
              <div className="space-y-2">
                <svg
                  className="w-10 h-10 mx-auto text-success-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div className="space-y-2">
                <svg
                  className="w-10 h-10 mx-auto text-muted"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      {step === 3 && (
        <div className="card space-y-6">
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Step 3: Analysis</h2>
            ...
            <>
              <div>
                <p className="text-sm text-surface-700 dark:text-surface-300 mb-3">
                  Extracted {extractedFrames.length} frames ({videoDuration.toFixed(1)}s video). 8
                  key frames will be sent for AI analysis.
                </p>
                <div className="grid grid-cols-4 sm:grid-cols-8 gap-1.5">
                  {extractedFrames
                    ...
                    .map((frame, i) => (
                      <div
                        key={i}
                        className="aspect-video rounded overflow-hidden bg-[var(--muted-bg)]"
                      >
