...
export default function LiveSessionPage() {
 ...
 {/* Session notes */}
 {session.notes && (
 <div className="px-4 py-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800">
 <p className="text-xs text-blue-700 dark:text-blue-300">{session.notes}</p>
 </div>
 )}
