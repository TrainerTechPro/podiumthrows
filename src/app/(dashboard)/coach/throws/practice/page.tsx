        ...
        <div className="card text-center py-16 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted mt-1 max-w-xs mx-auto">
              Start a live session to log attempts, distances, drill types, and coaching notes in
              real time.
            </p>
          </div>
          <button
...
function SessionCard({ session }: { session: PracticeSessionSummary }) {
  ...
  return (
    ...
    >
      ...
      <svg
        className="w-4 h-4 text-[var(--color-border-strong)] group-hover:text-primary-500 flex-shrink-0 transition-colors"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
