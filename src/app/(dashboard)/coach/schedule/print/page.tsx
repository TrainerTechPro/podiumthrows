...
/* ─── Print-specific CSS (static, no user input) ────────────────────────── */

const PRINT_STYLES = `
@media print {
  @page { margin: 1.5cm 1cm; size: portrait; }
  .print-session { break-inside: avoid; }
}
`;
...
export default async function PrintProgramPage({
  ...
  return (
    <div className="max-w-[800px] mx-auto print:max-w-none">
      ...
      {/* eslint-disable-next-line react/no-danger -- static CSS string, no user input */}
      ...
      <div className="mb-6 pb-4 border-b-2 border-black dark:border-white print:border-black">
        ...
        <div className="flex items-baseline justify-between gap-4 mt-1">
          ...
          <p className="text-sm font-mono tabular-nums print:text-black">
...
function SessionBlock({
  ...
  return (
    <div className="print-session border border-gray-300 dark:border-surface-700 rounded-lg p-3 print:border-gray-400 print:rounded-none">
      {/* Session header */}
