...
export default async function CoachSessionDetailPage({
  ...
  const { id: athleteId, assignmentId } = await params;
  ...
  // Verify the athlete ID matches the route
  if (assignment.athleteId !== athleteId) notFound();
