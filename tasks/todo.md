...
- **DONE 2026-05-21 — Throw-profile invite route retirement** — `/coach/throws/invite` now redirects to `/coach/athletes/invitations`, the redirect is covered in `e2e/coach-ia-redirects.spec.ts`, and active/legacy CTAs point at the canonical route directly.
- **DONE 2026-05-21 — Coach throws profile route retirement** — `/coach/throws/profile` and `/coach/throws/profile/typing` now redirect to canonical athlete detail/assessment routes. The old page files are gone, and remaining profile CTAs route straight to `/coach/athletes/:athleteId`.
